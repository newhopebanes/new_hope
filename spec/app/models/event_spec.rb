...
describe 'Events' do
  ...
  it 'returns a list of events' do
    result = Event.get_events(@params, false)
    puts result
  ...
  it 'filters list on events that occur on a given day' do
    ...
    @events <<  dated_event
    result = Event.get_events({ :date => "2035-02-15" }, false)
    result.length.should eq(1)
  end
