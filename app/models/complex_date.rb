class ComplexDate < ActiveRecord::Base
  attr_accessible :event_id, :date_type_id, :fixed_date, :time, :offset_type_id, :fixed_offset_id,
                  :dynamic_offset_id, :frequency_id, :fixed_frequency_id, :day_id, :date_type_attributes,
                  :offset_type_attributes, :fixed_offset_attributes, :dynamic_offset_attributes,
